...
<head>
  ...
  <title>Cadastrar Estádio | iSoccer</title>
</head>
...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
          ...
          <div class="col">
              <form action="cadastrar-estadio.php" method="POST">
                  <div class="row">
                      <div class="col">
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input required type="text" class="form-control" id="restrooms" name="restrooms">
                          </div>
                      </div>
                      <div class="col">
                          <div class="form-group">
                              <label for="snack_bars">Nº de lanchonetes</label>
                              <input required type="text" class="form-control" id="snack_bars" name="snack_bars">
                          </div>
                      </div>
                      <div class="col">
                          <div class="form-group">
