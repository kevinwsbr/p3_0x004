...
<head>
  ...
  <title>Cadastrar Preparador Físico | iSoccer</title>
</head>
...
<body>
  ...
  <div class="container">
      <div class="row">
          <div class="col">
              <h3>Cadastrar Preparador Físico</h3>
              <hr/>
          </div>
      </div>
      <div class="row">
          ...
          <div class="col">
              <form action="cadastrar-preparador.php" method="POST">
                  <div class="row">
                      <div class="col">
